...
@Component({
  ...
  template: `
    <div class="flex flex-col h-full w-full bg-white rounded-lg border border-gray-200 overflow-hidden">

      <!-- ÁREA PARA REMOÇÃO DE ARQUIVOS PDF DO BD-->
      <div
        class="h-14 shrink-0 px-4 flex mb-3 items-center bg-blue-50 border-b border-blue-100
      ...
      @if (isLoading()) {
        ...
        <div class="flex-1 relative min-h-0 w-full bg-white">
