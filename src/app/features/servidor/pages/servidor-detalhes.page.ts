...
import { DataInfoComponent } from '../component/data-info/data-info.component';
    ...
    >
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div class="flex items-center gap-3 w-full md:w-auto">
          ...
          <div class="flex-1 min-w-0">
            <h1
              [class.text-red-600]="type() === 'desligado'"
              class="text-xl md:text-2xl font-bold text-gray-800 leading-tight truncate md:whitespace-normal">
              Detalhes do Servidor {{ type() === 'desligado' ? '(DESLIGADO)' : '' }}
            </h1>
            <p class="text-sm text-gray-600 truncate">Visualização completa dos dados</p>
          </div>
        </div>
      ...
      @if (!isLoading() && servidor(); as s) {
        ...
        shadow-sm print:shadow-none overflow-hidden print:overflow-visible">
          ...
          <div class="p-4 md:p-6 bg-gray-50/50 print:bg-transparent print:p-0 print:break-inside-avoid">
            <h2 class="text-lg font-bold text-blue-700 mb-4 flex items-center gap-2">
