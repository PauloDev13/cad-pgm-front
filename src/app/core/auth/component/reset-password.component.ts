...
@Component({
  ...
  template: `
    <div div class="w-full max-w-md flex flex-col bg-white rounded-xl shadow-lg p-8">
      <app-header-login title="Criar Nova Senha" subtitle="Digite e confirme sua nova senha de acesso." />
